...
<section class="bg0 p-t-23 p-b-140" style="padding-top: 10%;">
    <div class="container">
        <div class="p-b-10" >
            <h3 class="ltext-103 cl5" >
                <p style="text-align: center; text-transform: none; font-family: Poppins-Medium;">Product Overview</p>
                <hr style="height:2px; width:20%; border-width:0; color:#ffab3e; background-color:#ffab3e; margin-right: 40%; margin-left: 40%;">
            </h3>
        </div>
        ...
        <div class="flex-w flex-sb-m p-b-52">
            ...
            <!-- Filter -->
            <div class="dis-none panel-filter w-full p-t-10" style="background-color: #fce8cf;">
                <div class="wrap-filter flex-w bg6 w-full p-lr-40 p-t-27 p-lr-15-sm" style="background-color: #fce8cf;">
        ...
        <div class="flex-c-m flex-w w-full p-t-45">
            <a href="#" class="flex-c-m stext-101 cl5 size-103 bg2 bor1 hov-btn1 p-lr-15 trans-04" style="background-color: #ffab3e;">
                <p style="font-family: Poppins-Bold; color: #fff; text-transform: none;">Load More</p>
            </a>
        </div>
    </div>
</section>
