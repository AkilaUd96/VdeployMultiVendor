...
<section class="section-slide">
    <div class="wrap-slick1">
        <div class="slick1">
            <div class="item-slick1" style="background-image: url({{asset('assets/images/slide-01-edit.png);')}}">
            ...
            <div class="item-slick1" style="background-image: url({{asset('assets/images/slide-02-edit.png);')}}">
                <div class="container h-full">
                    <div class="flex-col-l-m h-full p-t-100 p-b-30 respon5">
            ...
            <div class="item-slick1" style="background-image: url({{asset('assets/images/slide-03-edit.png);')}}">
                <div class="container h-full">
                    <div class="flex-col-l-m h-full p-t-100 p-b-30 respon5">
            ...
            <div class="col-sm-12" >
                ...
                <div class="row" style="margin-bottom: 80px;" >
                    <div class="col-sm-2" style="width: 100%; ">
                        <img src="{{asset('assets/images/123 (1).png')}}" style="height: 70px; margin: auto; display: block; margin-bottom: 20px;" />
                        <p style="font-family: Poppins-Medium; font-size: 14px; text-align: center; padding-bottom: 25px;">Photography</p>
                    </div>
                    <div class="col-sm-2">
                        <img src="{{asset('assets/images/123 (2).png')}}" style="height: 70px; margin: auto; display: block; margin-bottom: 20px;"/>
                        <p style="font-family: Poppins-Medium; font-size: 14px; text-align: center; padding-bottom: 25px;">Households</p>
                    </div>
                    <div class="col-sm-2">
                        <img src="{{asset('assets/images/123 (3).png ')}}" style="height: 70px; margin: auto; display: block; margin-bottom: 20px;"/>
                        <p style="font-family: Poppins-Medium; font-size: 14px; text-align: center; padding-bottom: 25px;">Groceries</p>
                    </div>
                    <div class="col-sm-2">
                        <img src="{{asset('assets/images/123 (4).png')}}" style="height: 70px; margin: auto; display: block; margin-bottom: 20px;"/>
                        <p style="font-family: Poppins-Medium; font-size: 14px; text-align: center; padding-bottom: 25px;">Pet Items</p>
                    </div>
                    <div class="col-sm-2">
                        <img src="{{asset('assets/images/123 (5).png')}}" style="height: 70px; margin: auto; display: block; margin-bottom: 20px;"/>
                        <p style="font-family: Poppins-Medium; font-size: 14px; text-align: center; padding-bottom: 25px;">Travelling</p>
                    </div>
                    <div class="col-sm-2">
                        <img src="{{asset('assets/images/123 (6).png')}}" style="height: 70px; margin: auto; display: block; margin-bottom: 20px;"/>
